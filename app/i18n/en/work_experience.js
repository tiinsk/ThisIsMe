export default {
      ...
      "microsoft_msthesis": {
        "title": "Thesis Worker",
        "company": "Nokia Oyj/Microsoft Corp.",
      ...
      "demola": {
        ...
        "company": "Demola Tampere/Intel Corp.",
        "description": "I worked approx. 10h/week in Demola Project. Our team (6 persons) researched and developed Google-street-view kind of service for indoors that could be automatized with a quadcopter. The project won the Best Project of Demola Spring 2015 award."

      },
      "guild": {
        "title": "Guild activity",
        "company": "Bioengineering Guild Bioner",
        "description": "I was part of Guilds Board. I arranged several events and I took main responsibility of guilds anniversary celebrations, café tour (Namiappro) and other events."
      },
      "tutoring": {
        "title": "Tutoring",
        "company": "Tampere University of Technology",
